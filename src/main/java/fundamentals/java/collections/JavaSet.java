 ...
 * <p>
 * Scala Set {@link fundamentals.scala.collections.ScalaSet}
 */
...
class SetOperations {
    ...
    static void performUnion(Set<String> s1, Set<String> s2) {
        Set<String> s1Unions2 = new HashSet<>(s1);
        s1Unions2.addAll(s2);
        System.out.println("s1 union s2: " + s1Unions2);
    }

    static void performIntersection(Set<String> s1, Set<String> s2) {
    ...
    static void performDifference(Set<String> s1, Set<String> s2) {
